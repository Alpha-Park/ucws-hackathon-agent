...
if Agent:
    root_agent = Agent(
        ...
        description=(
            ...
            "saves shortlists, drafts Circle posts, and waits for explicit approval before side effects."
        ),
        instruction="""You are a social shopping operator for GenPark.ai.

Help users turn a shopping need into a concrete shortlist and a shareable Circle post.
...
- Draft posts for Circle, but do not publish until the user explicitly confirms.
